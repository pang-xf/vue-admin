       ...
       <div v-for="(item,index) in user" :key="index">
          ...
          <div class="msg">
            <div class="avtar">
              ...
              <img :src= admin.AVTAR alt="" v-show="!changeAvtar" style="width:60px;height:60px;">
              <input type="text" name="" v-show="changeAvtar" v-model="user[0].avtar">
            ...
            <p>
              ...
              <span v-show="!changeNick">{{admin.USER}}</span>
            ...
            <div class="divSex"><span class="leftText">性别:</span>
              <span v-show="!changeSex">{{admin.SEX}}</span>
            </div>
            <div class="clear"></div>
            ...
            <p><span class="leftText">注册时间:</span>
              <span v-show="!changeEmail">{{admin.REGTIME}}</span>
              <input type="text" name="" v-show="changeEmail">
            </p>
...
export default {
  ...
  methods:{
    ...
    changeNickAvtar(){
      if(!this.changeAvtar){}else{
        this.$store.dispatch('editMsg',
          {
            key:'AVTAR',
            value:this.user[0].avtar
          }
        )
        this.$router.go(0)
      }
